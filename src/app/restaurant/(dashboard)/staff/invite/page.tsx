...
export default async function StaffInvitePage() {
   ...
   * The token belongs to this restaurant and expires after 24 hours.
   */
      ...
      <section className="overflow-hidden rounded-3xl bg-white shadow-sm ring-1 ring-gray-100">
        ...
        <div className="px-5 py-8 text-center sm:px-8 sm:py-10">
          ...
          <p className="mx-auto mt-2 max-w-md text-sm leading-6 text-gray-500">
            Give this QR code to the new staff member. They can scan it
            with their phone and complete their registration.
          </p>
